...
class CustomerTestCases(unittest.TestCase):
    def test__init__(self):
        ...
        self.my_customer.account_no=11
        self.my_customer.account_type="S"
        self.my_customer.balance=100
    def test_balance(self):
        """
        Tests if balance is set successfully or not
        """
        self.test__init__()
        self.assertEqual(self.my_customer.balance,100,msg=" Balance not Set")
    def test_deposit(self):
        ...
        self.assertEqual(self.my_customer.balance,600,msg=" Balance Not Updated after deposit")
    def test_withdraw(self):
        ...
        self.assertEqual(self.my_customer.balance,50,msg=" Balance Not Updated after withdraw")
        self.my_customer.withdraw(500)
        self.assertEqual(self.my_customer.balance,50,msg=" Withdraw Even when Not enough amount Available")
    def test_checkbalance(self):
        self.test__init__()
        self.assertEqual(self.my_customer.Checkbalance(),100,msg=" Checkbalance not works Properly")
    def test_transfermoney(self):
        ...
        prev_balance=dest_customer.Checkbalance()
        self.my_customer.Transfer_Money(5,50)
        self.assertEqual(self.my_customer.Checkbalance(),50,msg=" Trasfer from source Account")
        dest_customer.open_account(5)
        new_balance=dest_customer.Checkbalance()
        ...
        self.test__init__()
        self.my_customer.Transfer_Money(15,50)
        self.assertEqual(self.my_customer.Checkbalance(),100,msg=" Amount Transfer But dest not exist")
    def test_PayBills(self):
        """
        Tests if customer able to paybills Successfully
        """
        self.test__init__()
        self.my_customer.PayBills(50)
        self.assertEqual(self.my_customer.Checkbalance(),50,msg=" Bills not Pay")
    def test_requestnewaccount(self):
        ...
        acnt_no=dest_customer.account_no
        dest_customer.open_account(acnt_no)
        self.assertEqual(dest_customer.Checkbalance(),500,msg=" New Account Not Opened")
    def test_openaccount(self):
        ...
        self.assertNotEqual(f_customer.Checkbalance(),-1,msg=" Account Not Opened But it exists")
        s_customer=Customer("huma")
        s_customer.open_account(15)
        self.assertEqual(s_customer.Checkbalance(),-1,msg=" Account Open when it not exist")
